...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { category: @podcast.category, failed: @podcast.failed, feed_url: @podcast.feed_url, itunes_url: @podcast.itunes_url, title: @podcast.title } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { category: @podcast.category, failed: @podcast.failed, feed_url: @podcast.feed_url, itunes_url: @podcast.itunes_url, title: @podcast.title } }
